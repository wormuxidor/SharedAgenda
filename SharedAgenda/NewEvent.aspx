...
<body>
    ...
    <div class="Event">
        ...
        <asp:DropDownList runat="server" CssClass="subject_db" ID="subject_db"></asp:DropDownList><br />
        <asp:Label runat="server" CssClass="Text_Event" Text="Datum"></asp:Label><br />
        <asp:Calendar runat="server" CssClass="calender" ID="calender"></asp:Calendar><br />
        <asp:Label runat="server" CssClass="Text_Event" Text="Kurzbeschreibung"></asp:Label><br />
        <asp:TextBox runat="server" CssClass="tb_kBeschreibung" ID="tb_kBeschreibung"></asp:TextBox><br />
        <asp:Label runat="server" CssClass="Text_Event" Text="Eventtype"></asp:Label><br />
        <asp:RadioButtonList runat="server" CssClass="rb_eventtype" ID="rb_eventtype"></asp:RadioButtonList><br />
        <asp:Label runat="server" CssClass="Text_Event" Text="Beschreibung"></asp:Label><br />
        <asp:TextBox runat="server" CssClass="tb_Beschreibung" ID="tb_Beschreibung"></asp:TextBox><br />
